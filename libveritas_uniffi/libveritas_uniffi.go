...
func (c FfiConverterUpdateEntry) LowerExternal(value UpdateEntry) ExternalCRustBuffer {
	return RustBufferFromC(LowerIntoRustBuffer[UpdateEntry](c, value))
}
...
func (c FfiConverterSequenceUpdateEntry) LowerExternal(value []UpdateEntry) ExternalCRustBuffer {
	return RustBufferFromC(LowerIntoRustBuffer[[]UpdateEntry](c, value))
}
