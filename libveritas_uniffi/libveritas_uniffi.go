...
func uniffiCheckChecksums() {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_libveritas_uniffi_checksum_method_zone_alias()
		})
		if checksum != 2394 {
			// If this happens try cleaning and rebuilding your project
			panic("libveritas_uniffi: uniffi_libveritas_uniffi_checksum_method_zone_alias: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_libveritas_uniffi_checksum_method_zone_fallback_records()
		})
		if checksum != 24143 {
			// If this happens try cleaning and rebuilding your project
			panic("libveritas_uniffi: uniffi_libveritas_uniffi_checksum_method_zone_fallback_records: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_libveritas_uniffi_checksum_method_zone_records()
		})
		if checksum != 33064 {
			// If this happens try cleaning and rebuilding your project
			panic("libveritas_uniffi: uniffi_libveritas_uniffi_checksum_method_zone_records: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_libveritas_uniffi_checksum_constructor_veritas_with_dev_mode()
		})
		if checksum != 2007 {
			// If this happens try cleaning and rebuilding your project
			panic("libveritas_uniffi: uniffi_libveritas_uniffi_checksum_constructor_veritas_with_dev_mode: UniFFI API checksum mismatch")
		}
	}
}
...
type VeritasInterface interface {
	...
	VerifyMessage(ctx *QueryContext, msg *Message) (*VerifiedMessage, error)
}
type Veritas struct {
	ffiObject FfiObject
}
...
func VeritasWithDevMode(anchors *Anchors) (*Veritas, error) {
	_uniffiRV, _uniffiErr := rustCallWithError[VeritasError](FfiConverterVeritasError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_libveritas_uniffi_fn_constructor_veritas_with_dev_mode(FfiConverterAnchorsINSTANCE.Lower(anchors), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue *Veritas
		return _uniffiDefaultValue, _uniffiErr
...
// Verify a message against a query context.
func (_self *Veritas) VerifyMessage(ctx *QueryContext, msg *Message) (*VerifiedMessage, error) {
	_pointer := _self.ffiObject.incrementPointer("*Veritas")
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError[VeritasError](FfiConverterVeritasError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
...
func (_self *Zone) Alias() *string {
	...
	return FfiConverterOptionalStringINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_libveritas_uniffi_fn_method_zone_alias(
				_pointer, _uniffiStatus),
		}
	}))
}
...
func (_self *Zone) Records() *[]byte {
	_pointer := _self.ffiObject.incrementPointer("*Zone")
	defer _self.ffiObject.decrementPointer()
	return FfiConverterOptionalBytesINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_libveritas_uniffi_fn_method_zone_records(
				_pointer, _uniffiStatus),
		}
	}))
}
