...
func uniffiCheckChecksums() {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_libveritas_uniffi_checksum_method_message_set_signature()
		})
		if checksum != 56712 {
			// If this happens try cleaning and rebuilding your project
			panic("libveritas_uniffi: uniffi_libveritas_uniffi_checksum_method_message_set_signature: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
...
type MessageInterface interface {
	...
	SetSignature(signer string, signature []byte) error
...
// Set the signature on an unsigned record set.
func (_self *Message) SetSignature(signer string, signature []byte) error {
	...
	_, _uniffiErr := rustCallWithError[VeritasError](FfiConverterVeritasError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_libveritas_uniffi_fn_method_message_set_signature(
			_pointer, FfiConverterStringINSTANCE.Lower(signer), FfiConverterBytesINSTANCE.Lower(signature), _uniffiStatus)
		return false
	})
...
type MessageBuilderInterface interface {
	...
	AddHandle(chainBytes []byte, recordsBytes []byte, rev bool) error
	// Add records for a handle (sip7 wire bytes).
	AddRecords(handle string, recordsBytes []byte, rev bool) error
...
// Add a .spacecert chain with records (sip7 wire bytes).
func (_self *MessageBuilder) AddHandle(chainBytes []byte, recordsBytes []byte, rev bool) error {
	_pointer := _self.ffiObject.incrementPointer("*MessageBuilder")
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError[VeritasError](FfiConverterVeritasError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_libveritas_uniffi_fn_method_messagebuilder_add_handle(
			_pointer, FfiConverterBytesINSTANCE.Lower(chainBytes), FfiConverterBytesINSTANCE.Lower(recordsBytes), FfiConverterBoolINSTANCE.Lower(rev), _uniffiStatus)
		return false
	})
	return _uniffiErr.AsError()
}
...
// Add records for a handle (sip7 wire bytes).
func (_self *MessageBuilder) AddRecords(handle string, recordsBytes []byte, rev bool) error {
	_pointer := _self.ffiObject.incrementPointer("*MessageBuilder")
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError[VeritasError](FfiConverterVeritasError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_libveritas_uniffi_fn_method_messagebuilder_add_records(
			_pointer, FfiConverterStringINSTANCE.Lower(handle), FfiConverterBytesINSTANCE.Lower(recordsBytes), FfiConverterBoolINSTANCE.Lower(rev), _uniffiStatus)
		return false
	})
	return _uniffiErr.AsError()
}
...
func (r *BuildResult) Destroy() {
	...
	FfiDestroyerSequenceUnsignedRecord{}.Destroy(r.Unsigned)
}
...
func (c FfiConverterBuildResult) Read(reader io.Reader) BuildResult {
	return BuildResult{
		...
		FfiConverterSequenceUnsignedRecordINSTANCE.Read(reader),
	}
}
...
func (c FfiConverterBuildResult) Write(writer io.Writer, value BuildResult) {
	...
	FfiConverterSequenceUnsignedRecordINSTANCE.Write(writer, value.Unsigned)
}
...
func (r *DataUpdateEntry) Destroy() {
	...
	FfiDestroyerBool{}.Destroy(r.Rev)
}
...
func (c FfiConverterDataUpdateEntry) Write(writer io.Writer, value DataUpdateEntry) {
	...
	FfiConverterBoolINSTANCE.Write(writer, value.Rev)
}
...
func (r *UnsignedRecord) Destroy() {
	FfiDestroyerString{}.Destroy(r.Handle)
	FfiDestroyerString{}.Destroy(r.Signer)
	FfiDestroyerBytes{}.Destroy(r.SigningId)
}

type FfiConverterUnsignedRecord struct{}

var FfiConverterUnsignedRecordINSTANCE = FfiConverterUnsignedRecord{}

func (c FfiConverterUnsignedRecord) Lift(rb RustBufferI) UnsignedRecord {
	return LiftFromRustBuffer[UnsignedRecord](c, rb)
}

func (c FfiConverterUnsignedRecord) Read(reader io.Reader) UnsignedRecord {
...
func (c FfiConverterUnsignedRecord) Lower(value UnsignedRecord) C.RustBuffer {
	return LowerIntoRustBuffer[UnsignedRecord](c, value)
}

func (c FfiConverterUnsignedRecord) LowerExternal(value UnsignedRecord) ExternalCRustBuffer {
	return RustBufferFromC(LowerIntoRustBuffer[UnsignedRecord](c, value))
}

func (c FfiConverterUnsignedRecord) Write(writer io.Writer, value UnsignedRecord) {
	FfiConverterStringINSTANCE.Write(writer, value.Handle)
	FfiConverterStringINSTANCE.Write(writer, value.Signer)
	FfiConverterBytesINSTANCE.Write(writer, value.SigningId)
}

type FfiDestroyerUnsignedRecord struct{}

func (_ FfiDestroyerUnsignedRecord) Destroy(value UnsignedRecord) {
	value.Destroy()
}
...
func (e RecordSig) Destroy() {
	FfiDestroyerString{}.Destroy(e.Signer)
	FfiDestroyerString{}.Destroy(e.Rev)
...
func (FfiConverterRecord) Write(writer io.Writer, value Record) {
	...
	case RecordSig:
		writeInt32(writer, 5)
		FfiConverterStringINSTANCE.Write(writer, variant_value.Signer)
		FfiConverterStringINSTANCE.Write(writer, variant_value.Rev)
...
type FfiConverterSequenceUnsignedRecord struct{}

var FfiConverterSequenceUnsignedRecordINSTANCE = FfiConverterSequenceUnsignedRecord{}

func (c FfiConverterSequenceUnsignedRecord) Lift(rb RustBufferI) []UnsignedRecord {
	return LiftFromRustBuffer[[]UnsignedRecord](c, rb)
}

func (c FfiConverterSequenceUnsignedRecord) Read(reader io.Reader) []UnsignedRecord {
	length := readInt32(reader)
	if length == 0 {
		return nil
	}
	result := make([]UnsignedRecord, 0, length)
	for i := int32(0); i < length; i++ {
		result = append(result, FfiConverterUnsignedRecordINSTANCE.Read(reader))
	}
	return result
}

func (c FfiConverterSequenceUnsignedRecord) Lower(value []UnsignedRecord) C.RustBuffer {
	return LowerIntoRustBuffer[[]UnsignedRecord](c, value)
}

func (c FfiConverterSequenceUnsignedRecord) LowerExternal(value []UnsignedRecord) ExternalCRustBuffer {
	return RustBufferFromC(LowerIntoRustBuffer[[]UnsignedRecord](c, value))
}

func (c FfiConverterSequenceUnsignedRecord) Write(writer io.Writer, value []UnsignedRecord) {
	if len(value) > math.MaxInt32 {
		panic("[]UnsignedRecord is too large to fit into Int32")
	}

	writeInt32(writer, int32(len(value)))
	for _, item := range value {
		FfiConverterUnsignedRecordINSTANCE.Write(writer, item)
	}
}

type FfiDestroyerSequenceUnsignedRecord struct{}

func (FfiDestroyerSequenceUnsignedRecord) Destroy(sequence []UnsignedRecord) {
	for _, value := range sequence {
		FfiDestroyerUnsignedRecord{}.Destroy(value)
	}
}
